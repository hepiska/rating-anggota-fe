...
import { getAnggotaDetail, upload, editAnggota } from "services";
import { Base_url } from "constant";

class DetailAnggotaPage extends React.Component {
  state = {
    rating: {},
    modalStatus: false,
    isEdit: false
  ...
  onSubmit = () => {
    editAnggota(this.props.match.params.id, this.state.userData).then(() => {
      this.props.history.push("/dashboard/anggota");
    });
  };
  render() {
